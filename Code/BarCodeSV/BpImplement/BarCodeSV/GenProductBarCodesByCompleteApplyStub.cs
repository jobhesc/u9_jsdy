...
namespace UFIDA.U9.Cust.JSDY.BarCode
{
    ...
    public class GenProductBarCodesByCompleteApplyStub : ServiceStubBase, IGenProductBarCodesByCompleteApply
    {
        #region IGenProductBarCodesByCompleteApply Members

        //[OperationBehavior]
        public void Do(IContext context ,out IList<MessageBase> outMessages, List<UFIDA.U9.Cust.JSDY.BarCode.ProductBarCodeByCompleteApplyDTOData> productBarCodeDTOs)
        {
