...
namespace UFIDA.U9.Cust.JSDY.CompleteApplyBarCodeBListUIModel
{
    public partial class CompleteApplyBarCodeBListUIFormWebPart
    {
		...
		Action.OnPrint(sender,new UIActionEventArgs());
				...
				//MethodName:BtnPrintBarCode_Click ActionName:OnPrintBarCode
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnPrintBarCode_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnPrintBarCode_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnPrintBarCode_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.OnPrintBarCode(sender,new UIActionEventArgs());
