...
/***********************************************************************************************
 * Form ID:03ecb4c3-9135-42b8-89c2-9f82cc483e46 
 * Form Name:CheckBarCodeBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.JSDY.CheckBarCodeBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.JSDY.BarCodeUI","UFIDA.U9.Cust.JSDY.CheckBarCodeBListUIModel.CheckBarCodeBListUIFormWebPart", "UFIDA.U9.Cust.JSDY.BarCodeUI.WebPart", "03ecb4c3-9135-42b8-89c2-9f82cc483e46","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.JSDY.BarCodeUI', 'UFIDA.U9.Cust.JSDY.CheckBarCodeBListUIModel.CheckBarCodeBListUIFormWebPart', 'UFIDA.U9.Cust.JSDY.BarCodeUI.WebPart', '03ecb4c3-9135-42b8-89c2-9f82cc483e46')
	///<siteMapNode url="~/erp/simple.aspx?lnk=03ecb4c3-9135-42b8-89c2-9f82cc483e46" title="CheckBarCodeBListUIForm"/>
    public partial class CheckBarCodeBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(CheckBarCodeBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new CheckBarCodeBListUIModelAction Action
		{
			get { return (CheckBarCodeBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		CheckBarCodeBListUIModelModel _uimodel=null;
		public new CheckBarCodeBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new CheckBarCodeBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as CheckBarCodeBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public CheckBarCodeBListUIFormWebPart()
        {
            FormID = "03ecb4c3-9135-42b8-89c2-9f82cc483e46";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new CheckBarCodeBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (CheckBarCodeBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new CheckBarCodeBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"CheckBarCodeBListUIForm",true,992,504);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","2f075718-e747-490c-b52e-5a6cd5995427");
		...
		{
			QryService.BindEnum("DDLCase", this, "05c71af3-17ec-47d7-a889-27e60df5a5b7");
		}
