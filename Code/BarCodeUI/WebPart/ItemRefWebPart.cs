...
/***********************************************************************************************
 * Form ID:b2ccf05d-c424-4574-af1c-469aa085f418 
 * Form Name:ItemRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace ItemRef
{
	[FormRegister("UFIDA.U9.Cust.JSDY.BarCodeUI","ItemRef.ItemRefWebPart", "UFIDA.U9.Cust.JSDY.BarCodeUI.WebPart", "b2ccf05d-c424-4574-af1c-469aa085f418","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.JSDY.BarCodeUI', 'ItemRef.ItemRefWebPart', 'UFIDA.U9.Cust.JSDY.BarCodeUI.WebPart', 'b2ccf05d-c424-4574-af1c-469aa085f418')
	///<siteMapNode url="~/erp/simple.aspx?lnk=b2ccf05d-c424-4574-af1c-469aa085f418" title="ItemRef"/>
    public partial class ItemRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(ItemRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new ItemRefAction Action
		{
			get { return (ItemRefAction)base.Action; }
			set { base.Action = value; }
		}
		ItemRefModel _uimodel=null;
		public new ItemRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new ItemRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as ItemRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public ItemRefWebPart()
        {
            FormID = "b2ccf05d-c424-4574-af1c-469aa085f418";
	...
	//获取档案版型结果: G
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"ItemRef",true,580,408);
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","af7cf92c-a78c-4773-a3f1-a3f3b8e6843d");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","37fd775c-9f50-444e-a4ce-65f87e6cbf13");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","8e7c4b29-55d6-4106-a572-d178c2cbb582");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","691f397c-9844-4d66-959d-f5409cf34f6b");
            _UFListControl.Items.Add(listItem);
        }
