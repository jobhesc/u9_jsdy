...
namespace UFIDA.U9.Cust.JSDY.BarCode
{
	...
	/// 
	/// </summary>
	public  partial class CompleteApplyBarCodeDTO  : UFSoft.UBF.Business.DTOBase
	{
		#region Constructor
		...
		/// Constructor
		/// </summary>
		public CompleteApplyBarCodeDTO(){
			initData();
		}
		...
		private void DeSerializeKey(CompleteApplyBarCodeDTOData data)
		{
		...
		/// </summary>
		public void FromEntityData(CompleteApplyBarCodeDTOData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(CompleteApplyBarCodeDTOData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public CompleteApplyBarCodeDTOData ToEntityData()
		{
		...
		/// </summary>
		public CompleteApplyBarCodeDTOData ToEntityData(CompleteApplyBarCodeDTOData data, IDictionary dict){
			if (data == null)
				data = new CompleteApplyBarCodeDTOData();
			if (dict == null ) 
				dict = new Hashtable() ;
			else
            {
                ...
                {
                    data = (CompleteApplyBarCodeDTOData)dict[this];
                    return data;
                }
            }
			dict[this] = data;
