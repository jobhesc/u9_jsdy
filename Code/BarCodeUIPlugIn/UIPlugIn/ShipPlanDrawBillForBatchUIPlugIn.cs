...
{
    partial class ShipPlanDrawBillForBatchUIPlugIn : UFSoft.UBF.UI.Custom.ExtendedPartBase
    {
        #region 字段与属性
        ...
        public override void AfterInit(UFSoft.UBF.UI.IView.IPart part, EventArgs args)
        {
            ...
            //增加查询库存按钮
            this.btnQueryWhQoh = UIControlBuilder.BuilderUFButton(Card0, true, "btnQueryWhQoh", true, true, 80, 20, 4, 0, 1, 1, "100", "", "", "btnQueryWhQoh", false, "", "", "7a847b62-5778-42db-abed-e41fb6130a76");
